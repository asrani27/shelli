...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="/">Admin</a>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="/theme/template/images/faces/face28.jpg" alt="profile" />
                        </a>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Bootstrap admin
                            template from BootstrapDash. All rights reserved.</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">SHELLI<i
    ...
    <script src="/theme/template/vendors/chart.js/Chart.min.js"></script>
    <script src="/theme/template/vendors/datatables.net/jquery.dataTables.js"></script>
    <script src="/theme/template/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
    <script src="/theme/template/js/dataTables.select.min.js"></script>
    ...
    <script src="/theme/template/js/dashboard.js"></script>
    <script src="/theme/template/js/Chart.roundedBarCharts.js"></script>
