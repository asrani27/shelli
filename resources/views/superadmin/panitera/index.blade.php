...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-2 text-gray-800">Jaksa</h1>
    <a href="/superadmin/umum/jaksa/create" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/superadmin/umum/panitera/edit/{{$item->id}}" class="badge badge-success">
                                        Edit
                                    </a>
                                    <a href="/superadmin/umum/panitera/delete/{{$item->id}}" class="badge badge-danger">
                                        Delete
                                    </a>
                                </td>
                            </tr>
