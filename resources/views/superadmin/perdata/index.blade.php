...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-2 text-gray-800">Data Perdata</h1>
</div>
<div class="row">
                    ...
                    <table class="table table-striped table-bordered" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/superadmin/perkara/perdata/hjp/{{$item->id}}" class="badge badge-success">
                                        H J P
                                    </a>
                                    <a href="/superadmin/perkara/perdata/delete/{{$item->id}}"
                                        class="badge badge-danger">
                                        Delete
                                    </a>
                                    @if ($item->sidang == null)
                                    <a href="/superadmin/perkara/perdata/sidang/{{$item->id}}"
