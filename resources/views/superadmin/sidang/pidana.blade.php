...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-2 text-gray-800">Sidang Pidana</h1>
</div>
<div class="row">
                    ...
                    <table class="table table-striped table-bordered" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/superadmin/sidang/pdn/delete/{{$item->id}}" class="badge badge-danger">
                                        Delete
                                    </a>
                                    <a href="/superadmin/sidang/pdn/update_trk/{{$item->id}}"
